...
import homeWebFlowData from './homeWebFlowData'; // Ensure Correct Import

const HomeWebFlow = () => {
  return (
    <div className="relative w-full h-[63vh] md:h-[75vh] lg:h-[60vh] overflow-hidden">
      {/* Background Image */}
      ...
      <div className="relative z-10 flex items-center px-6 md:px-12 lg:px-20 h-full">
        <div className="max-w-[55%] text-white space-y-6">
          ...
          <button className="bg-indigo-600 hover:bg-white text-white hover:text-indigo-600 transition-all w-full md:w-1/2 lg:w-1/3 font-bold py-4 text-lg rounded-lg">
