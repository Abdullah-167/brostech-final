    ...
    <>
      <div className="main-div mt-24">
        <div className="lg:flex md:flex  px-4 gap-20 m-14">
          <div>
            <h1 className="lg:text-5xl md:text-3xl sm:text-xl font-bold lg:py-5 md:py-3 sm:py-1">
              Better together
            </h1>
            <h1 className="lg:text-lg md:text-sm  lg:py-7 md:py-3 sm:py-1">
              ...
              that solve critical problems and leave a smile on your face at the
              same time.
            </h1>
            <h1 className="lg:text-lg md:text-sm ">
              We love our job and love helping our clients. Life is just too
              short to not enjoy every minute!
            </h1>
