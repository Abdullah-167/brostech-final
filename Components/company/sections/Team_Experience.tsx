      ...
      <div className="team-experience bg-gradient-to-r from-yellow-100 to-blue-100">
        <div className="lg:p-32 md:p-16 sm:p-5 lg:mx-48 md:mx-32 sm:mx-14 text-center">
          ...
          <h3 className="text-lg">
            Since 2019, our dedication has been assisting customers, ensuring
            they receive top-notch custom services tailored to empower them in
            advancing, expanding, and innovating within their industry.
          </h3>
