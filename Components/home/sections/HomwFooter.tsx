...
export default function HomwFooter() {
  return (
    <footer className="bg-black text-white py-16 mt-20">
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16 mt-10">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-lime-400 leading-tight mt-4">
            Innovative Software Solutions?
          </h1>
          <button className="mt-10 px-8 py-4 md:px-10 md:py-5 bg-primary hover:bg-yellow-500 text-white text-lg md:text-xl font-semibold rounded-md transition">
      ...
      <div className="mt-16 border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center px-6 md:px-20 lg:px-40">
        ...
        <div className="flex flex-wrap justify-center md:justify-start space-x-4 md:space-x-6 text-gray-400 text-sm md:text-lg">
          {footerData.policies.map((policy, index) => (
            <Link key={index} href={policy.link} className="hover:text-white transition">
              {policy.text}
            </Link>
          ))}
        </div>
        ...
        <div className="flex space-x-3 md:space-x-4 mt-4 md:mt-0">
          <Link href="#" className="bg-lime-400 p-3 rounded-full hover:scale-110 transition hover:bg-black hover:text-white">
