      ...
      <div className="max-w-6xl w-full flex flex-wrap-reverse lg:grid grid-cols-1 lg:grid-cols-12 gap-6 bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
        ...
        <div className="p-6 lg:col-span-4 bg-white flex flex-col justify-center">
          ...
          <p className="text-gray-600 mb-4">
            Have a project in mind? Reach out to us via phone, email, or visit
            our office.
          </p>
          <div className="space-y-4">
            <ContactItem
              icon={<FiPhone />}
              title="+923364987786"
              subtitle="Call us: Sat - Thu 1pm - 9pm"
            />
            <ContactItem
              icon={<FiMapPin />}
              title="Sargodha Road, Faisalabad"
              subtitle="M57 Pearl City"
            />
            <ContactItem
              icon={<FiMail />}
              title="hr@broshtech.com"
